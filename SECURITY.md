...
codesmith is a coding agent with direct access to file operations, shell execution, and the network. Security disclosures are taken seriously.
...
Check the [releases page](https://github.com/camilesing/CodeSmith/releases) for the current version.
...
- **GitHub private advisory**: [github.com/camilesing/CodeSmith/security/advisories/new](https://github.com/camilesing/CodeSmith/security/advisories/new)
...
- Denial of service / rate-limit exhaustion against LLM provider APIs
- Vulnerabilities in third-party dependencies (report to the upstream project)
- Attacks requiring physical access to the victim's machine
- Theoretical ML-model injection attacks not demonstrated in the codesmith context
