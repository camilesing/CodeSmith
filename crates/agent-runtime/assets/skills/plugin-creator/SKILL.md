---
name: plugin-creator
description: Scaffold codesmith local plugin directories and activation notes. Use when the user asks to create, package, or sketch a plugin for codesmith.
---
