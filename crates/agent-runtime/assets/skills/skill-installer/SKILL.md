...
description: Install, update, trust, or inspect CodeSmith skills from GitHub or local skill folders. Use when the user asks for available skills or wants a community skill installed.
---
...
2. Prefer CodeSmith's native `/skill` commands over ad hoc copying.
...
5. If a skill conflicts by name with a workspace skill, explain that workspace
   skill directories take precedence over global `~/.codesmith/skills`.
