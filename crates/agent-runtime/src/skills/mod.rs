...
/// CodeSmith's global skills directory (`~/.codesmith/skills`), falling
/// back to `/tmp/codesmith/skills` when no home directory is available.
#[must_use]
...
impl SkillRegistry {
    ...
    fn push_warning(&mut self, warning: String) {
        tracing::warn!("skill load warning: {}", warning);
