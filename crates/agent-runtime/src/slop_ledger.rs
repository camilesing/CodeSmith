...
//! ## Design
//!
//! - **Storage**: `~/.codesmith/slop_ledger.json` (a JSON array of entries).
...
impl SlopLedger {
    ...
    pub fn default_path() -> io::Result<PathBuf> {
        codesmith_config::resolve_state_dir("slop_ledger")
...
/// to the portable `~/.codesmith/secrets` form.
