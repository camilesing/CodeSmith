...
impl ToolContext {
    ...
    pub fn new(workspace: impl Into<PathBuf>) -> Self {
        ...
        let notes_path = codesmith_config::resolve_project_state_dir(&workspace, "notes.md");
        let mcp_config_path = codesmith_config::resolve_project_state_dir(&workspace, "mcp.json");
