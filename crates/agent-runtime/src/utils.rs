...
/// 2. Writes a crash dump to `~/.codesmith/crashes/<timestamp>-<name>.log`.
///
...
/// Write a panic dump file to `~/.codesmith/crashes/`.
///
...
/// panics, a crash dump is written to `~/.codesmith/crashes/` and the panic
