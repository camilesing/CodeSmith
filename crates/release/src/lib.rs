...
pub const LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/Hmbown/CodeSmith/releases/latest";

/// GitHub API URL listing recent releases (up to 100), used to find beta tags.
pub const RELEASES_URL: &str =
    "https://api.github.com/repos/Hmbown/CodeSmith/releases?per_page=100";
...
const CNB_RELEASE_ASSET_BASE: &str = "https://cnb.cool/Hmbown/CodeSmith/-/releases";
