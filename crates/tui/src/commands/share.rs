...
<title>codesmith Session Export</title>
<style>
  body {{
...
<div class="footer">
  Generated by codesmith · https://github.com/camilesing/CodeSmith
</div>
</body>
</html>"#,
    )
...
mod tests {
    ...
    fn test_render_session_html_basic_structure() {
        ...
        assert!(html.contains("codesmith"));
    }
    ...
    fn test_render_session_html_metadata() {
        ...
        assert!(html.contains("https://github.com/camilesing/CodeSmith"));
    }
}
