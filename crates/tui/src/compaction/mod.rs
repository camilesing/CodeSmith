...
///
/// Re-exported from `codesmith_agent_runtime::compaction::CompactionConfig`
/// so the engine and TUI share the same compaction config type.
pub use codesmith_agent_runtime::compaction::{CompactionConfig, MINIMUM_AUTO_COMPACTION_TOKENS};
