...
// Dark palette — improved contrast and layer separation.
pub const DARK_BG_RGB: (u8, u8, u8) = (10, 17, 32); // #0A1120 Deep Navy
pub const DARK_PANEL_RGB: (u8, u8, u8) = (22, 34, 56); // #162238
pub const DARK_ELEVATED_RGB: (u8, u8, u8) = (36, 52, 78); // #24344E
pub const DARK_SELECTION_RGB: (u8, u8, u8) = (40, 56, 84); // #283854 — darker to avoid bright pop on deep navy
pub const DARK_TEXT_BODY_RGB: (u8, u8, u8) = (246, 242, 232); // #F6F2E8 Ivory
pub const DARK_TEXT_SOFT_RGB: (u8, u8, u8) = (217, 224, 234); // #D9E0EA
pub const DARK_TEXT_MUTED_RGB: (u8, u8, u8) = (169, 180, 199); // #A9B4C7 Mist Gray
pub const DARK_TEXT_HINT_RGB: (u8, u8, u8) = (138, 150, 174); // #8A96AE
#[allow(dead_code)]
pub const DARK_TEXT_DIM_RGB: (u8, u8, u8) = (118, 130, 156); // #76829C
pub const DARK_ACCENT_PRIMARY_RGB: (u8, u8, u8) = (246, 196, 83); // #F6C453 Signal Gold
pub const DARK_ACCENT_SECONDARY_RGB: (u8, u8, u8) = (79, 209, 197); // #4FD1C5 Seafoam
pub const DARK_ACCENT_ACTION_RGB: (u8, u8, u8) = (255, 122, 89); // #FF7A59 Coral Spark
pub const DARK_ERROR_RGB: (u8, u8, u8) = (255, 92, 122); // #FF5C7A Rose Red
pub const DARK_ERROR_HOVER_RGB: (u8, u8, u8) = (255, 120, 144); // #FF7890 Rose Hover
pub const DARK_ERROR_SURFACE_RGB: (u8, u8, u8) = (42, 18, 26); // #2A121A Error Surface
pub const DARK_ERROR_BORDER_RGB: (u8, u8, u8) = (255, 138, 160); // #FF8AA0 Error Border
pub const DARK_ERROR_TEXT_RGB: (u8, u8, u8) = (255, 214, 222); // #FFD6DE Error Text
pub const DARK_WARNING_RGB: (u8, u8, u8) = (240, 160, 48); // #F0A030
pub const DARK_SUCCESS_RGB: (u8, u8, u8) = (79, 209, 197); // #4FD1C5 Seafoam
pub const DARK_INFO_RGB: (u8, u8, u8) = (106, 174, 242); // #6AAEF2 Sky
pub const DARK_BORDER_RGB: (u8, u8, u8) = (52, 88, 145); // #345891
pub const DARK_REASONING_TEXT_RGB: (u8, u8, u8) = (224, 153, 72); // #E09948
pub const DARK_REASONING_SURFACE_RGB: (u8, u8, u8) = (42, 34, 24); // #2A2218
pub const DARK_REASONING_TINT_RGB: (u8, u8, u8) = (24, 36, 52); // #182434
...
pub const DARK_DIFF_ADDED_RGB: (u8, u8, u8) = (87, 199, 133); // #57C785
#[allow(dead_code)]
pub const DARK_DIFF_DELETED_RGB: (u8, u8, u8) = (255, 92, 122); // #FF5C7A Rose Red
pub const DARK_DIFF_ADDED_BG_RGB: (u8, u8, u8) = (18, 42, 34); // #122A22
pub const DARK_DIFF_DELETED_BG_RGB: (u8, u8, u8) = (42, 18, 26); // #2A121A
pub const DARK_MODE_AGENT_RGB: (u8, u8, u8) = (80, 150, 255); // #5096FF
pub const DARK_MODE_YOLO_RGB: (u8, u8, u8) = (255, 100, 100); // #FF6464
pub const DARK_MODE_PLAN_RGB: (u8, u8, u8) = (246, 196, 83); // #F6C453 Signal Gold
pub const DARK_MODE_GOAL_RGB: (u8, u8, u8) = (100, 220, 160); // #64DCA0
pub const DARK_TOOL_LIVE_RGB: (u8, u8, u8) = (140, 190, 238); // #8CBEEE
pub const DARK_TOOL_ISSUE_RGB: (u8, u8, u8) = (198, 150, 160); // #C696A0
pub const DARK_TOOL_OUTPUT_RGB: (u8, u8, u8) = (194, 208, 224); // #C2D0E0
pub const DARK_TOOL_SURFACE_RGB: (u8, u8, u8) = (28, 40, 62); // #1C283E
pub const DARK_TOOL_ACTIVE_RGB: (u8, u8, u8) = (38, 54, 80); // #263650

// Backward-compatible aliases for existing call sites.
pub const CODESMITH_BLUE_RGB: (u8, u8, u8) = DARK_ACCENT_PRIMARY_RGB;
pub const CODESMITH_SKY_RGB: (u8, u8, u8) = DARK_INFO_RGB;
pub const CODESMITH_INK_RGB: (u8, u8, u8) = DARK_BG_RGB;
pub const CODESMITH_SLATE_RGB: (u8, u8, u8) = DARK_PANEL_RGB;
pub const CODESMITH_RED_RGB: (u8, u8, u8) = DARK_ERROR_RGB;
...
// New semantic colors
pub const BORDER_COLOR_RGB: (u8, u8, u8) = DARK_BORDER_RGB; // #2A4A7F
...
pub const TEXT_BODY: Color = Color::Rgb(
    DARK_TEXT_BODY_RGB.0,
    DARK_TEXT_BODY_RGB.1,
    DARK_TEXT_BODY_RGB.2,
);
pub const TEXT_SECONDARY: Color = Color::Rgb(
    DARK_TEXT_MUTED_RGB.0,
    DARK_TEXT_MUTED_RGB.1,
    DARK_TEXT_MUTED_RGB.2,
);
pub const TEXT_HINT: Color = Color::Rgb(
    DARK_TEXT_HINT_RGB.0,
    DARK_TEXT_HINT_RGB.1,
    DARK_TEXT_HINT_RGB.2,
);
pub const TEXT_ACCENT: Color = Color::Rgb(
    DARK_ACCENT_SECONDARY_RGB.0,
    DARK_ACCENT_SECONDARY_RGB.1,
    DARK_ACCENT_SECONDARY_RGB.2,
);
...
pub const TEXT_SOFT: Color = Color::Rgb(
    DARK_TEXT_SOFT_RGB.0,
    DARK_TEXT_SOFT_RGB.1,
    DARK_TEXT_SOFT_RGB.2,
);
pub const TEXT_REASONING: Color = Color::Rgb(
    DARK_REASONING_TEXT_RGB.0,
    DARK_REASONING_TEXT_RGB.1,
    DARK_REASONING_TEXT_RGB.2,
);
...
pub const ACCENT_PRIMARY: Color = Color::Rgb(
    DARK_ACCENT_PRIMARY_RGB.0,
    DARK_ACCENT_PRIMARY_RGB.1,
    DARK_ACCENT_PRIMARY_RGB.2,
);
#[allow(dead_code)]
...
#[allow(dead_code)]
pub const BACKGROUND_DARK: Color = Color::Rgb(DARK_BG_RGB.0, DARK_BG_RGB.1, DARK_BG_RGB.2);
#[allow(dead_code)]
pub const STATUS_NEUTRAL: Color = TEXT_MUTED;
#[allow(dead_code)]
pub const SURFACE_PANEL: Color = Color::Rgb(DARK_PANEL_RGB.0, DARK_PANEL_RGB.1, DARK_PANEL_RGB.2);
#[allow(dead_code)]
...
pub const SURFACE_REASONING: Color = Color::Rgb(
    DARK_REASONING_SURFACE_RGB.0,
    DARK_REASONING_SURFACE_RGB.1,
    DARK_REASONING_SURFACE_RGB.2,
);
pub const SURFACE_REASONING_TINT: Color = Color::Rgb(
    DARK_REASONING_TINT_RGB.0,
    DARK_REASONING_TINT_RGB.1,
    DARK_REASONING_TINT_RGB.2,
);
#[allow(dead_code)]
pub const SURFACE_REASONING_ACTIVE: Color = Color::Rgb(58, 46, 32);
#[allow(dead_code)]
pub const SURFACE_TOOL: Color = Color::Rgb(
    DARK_TOOL_SURFACE_RGB.0,
    DARK_TOOL_SURFACE_RGB.1,
    DARK_TOOL_SURFACE_RGB.2,
);
#[allow(dead_code)]
pub const SURFACE_TOOL_ACTIVE: Color = Color::Rgb(
    DARK_TOOL_ACTIVE_RGB.0,
    DARK_TOOL_ACTIVE_RGB.1,
    DARK_TOOL_ACTIVE_RGB.2,
);
#[allow(dead_code)]
pub const SURFACE_SUCCESS: Color = Color::Rgb(18, 42, 37); // dark teal tint
#[allow(dead_code)]
pub const SURFACE_ERROR: Color = Color::Rgb(
    DARK_ERROR_SURFACE_RGB.0,
    DARK_ERROR_SURFACE_RGB.1,
    DARK_ERROR_SURFACE_RGB.2,
);
pub const DIFF_ADDED_BG: Color = Color::Rgb(
    DARK_DIFF_ADDED_BG_RGB.0,
    DARK_DIFF_ADDED_BG_RGB.1,
    DARK_DIFF_ADDED_BG_RGB.2,
);
pub const DIFF_DELETED_BG: Color = Color::Rgb(
    DARK_DIFF_DELETED_BG_RGB.0,
    DARK_DIFF_DELETED_BG_RGB.1,
    DARK_DIFF_DELETED_BG_RGB.2,
);
pub const DIFF_ADDED: Color = Color::Rgb(
    DARK_DIFF_ADDED_RGB.0,
    DARK_DIFF_ADDED_RGB.1,
    DARK_DIFF_ADDED_RGB.2,
);
...
pub const ACCENT_TOOL_LIVE: Color = Color::Rgb(
    DARK_TOOL_LIVE_RGB.0,
    DARK_TOOL_LIVE_RGB.1,
    DARK_TOOL_LIVE_RGB.2,
);
pub const ACCENT_TOOL_ISSUE: Color = Color::Rgb(
    DARK_TOOL_ISSUE_RGB.0,
    DARK_TOOL_ISSUE_RGB.1,
    DARK_TOOL_ISSUE_RGB.2,
);
pub const TEXT_TOOL_OUTPUT: Color = Color::Rgb(
    DARK_TOOL_OUTPUT_RGB.0,
    DARK_TOOL_OUTPUT_RGB.1,
    DARK_TOOL_OUTPUT_RGB.2,
);

// Legacy status colors - keep for backward compatibility
pub const STATUS_SUCCESS: Color =
    Color::Rgb(DARK_SUCCESS_RGB.0, DARK_SUCCESS_RGB.1, DARK_SUCCESS_RGB.2);
pub const STATUS_WARNING: Color =
    Color::Rgb(DARK_WARNING_RGB.0, DARK_WARNING_RGB.1, DARK_WARNING_RGB.2);
pub const STATUS_ERROR: Color = Color::Rgb(DARK_ERROR_RGB.0, DARK_ERROR_RGB.1, DARK_ERROR_RGB.2);
#[allow(dead_code)]
pub const STATUS_INFO: Color = Color::Rgb(DARK_INFO_RGB.0, DARK_INFO_RGB.1, DARK_INFO_RGB.2);

// Mode-specific accent colors for mode badges
pub const MODE_AGENT: Color = Color::Rgb(
    DARK_MODE_AGENT_RGB.0,
    DARK_MODE_AGENT_RGB.1,
    DARK_MODE_AGENT_RGB.2,
);
pub const MODE_YOLO: Color = Color::Rgb(
    DARK_MODE_YOLO_RGB.0,
    DARK_MODE_YOLO_RGB.1,
    DARK_MODE_YOLO_RGB.2,
);
pub const MODE_PLAN: Color = Color::Rgb(
    DARK_MODE_PLAN_RGB.0,
    DARK_MODE_PLAN_RGB.1,
    DARK_MODE_PLAN_RGB.2,
);
pub const MODE_GOAL: Color = Color::Rgb(
    DARK_MODE_GOAL_RGB.0,
    DARK_MODE_GOAL_RGB.1,
    DARK_MODE_GOAL_RGB.2,
);

pub const SELECTION_BG: Color = Color::Rgb(
    DARK_SELECTION_RGB.0,
    DARK_SELECTION_RGB.1,
    DARK_SELECTION_RGB.2,
);
#[allow(dead_code)]
...
pub const UI_THEME: UiTheme = UiTheme {
    ...
    accent_action: Color::Rgb(
        DARK_ACCENT_ACTION_RGB.0,
        DARK_ACCENT_ACTION_RGB.1,
        DARK_ACCENT_ACTION_RGB.2,
    ),
    error_fg: Color::Rgb(DARK_ERROR_RGB.0, DARK_ERROR_RGB.1, DARK_ERROR_RGB.2),
    error_hover: Color::Rgb(
        DARK_ERROR_HOVER_RGB.0,
        DARK_ERROR_HOVER_RGB.1,
        DARK_ERROR_HOVER_RGB.2,
    ),
    ...
    error_border: Color::Rgb(
        DARK_ERROR_BORDER_RGB.0,
        DARK_ERROR_BORDER_RGB.1,
        DARK_ERROR_BORDER_RGB.2,
    ),
    error_text: Color::Rgb(
        DARK_ERROR_TEXT_RGB.0,
        DARK_ERROR_TEXT_RGB.1,
        DARK_ERROR_TEXT_RGB.2,
    ),
    warning: Color::Rgb(DARK_WARNING_RGB.0, DARK_WARNING_RGB.1, DARK_WARNING_RGB.2),
    success: Color::Rgb(DARK_SUCCESS_RGB.0, DARK_SUCCESS_RGB.1, DARK_SUCCESS_RGB.2),
    info: Color::Rgb(DARK_INFO_RGB.0, DARK_INFO_RGB.1, DARK_INFO_RGB.2),
    ...
    diff_deleted_fg: Color::Rgb(DARK_ERROR_RGB.0, DARK_ERROR_RGB.1, DARK_ERROR_RGB.2),
...
impl ThemeId {
    ...
    /// Accepts `"dark"` and `"light"` plus their common aliases
    ...
    pub const fn tagline(self) -> &'static str {
        match self {
            ...
            Self::Dark => "Dark — deep navy & gold",
            Self::Light => "Light, paper-ish",
...
/// default Dark and System themes pass through unchanged so this whole
...
mod tests {
    use super::{
        ...
        ColorDepth, DARK_REASONING_TEXT_RGB, DARK_REASONING_TINT_RGB, DARK_TEXT_BODY_RGB,
        DIFF_ADDED, DIFF_ADDED_BG, GRAYSCALE_BORDER, GRAYSCALE_ELEVATED, GRAYSCALE_PANEL,
        ...
        LIGHT_UI_THEME, PaletteMode, SOLARIZED_LIGHT_UI_THEME, SOLARIZED_PANEL, SOLARIZED_SURFACE,
        ...
        UI_THEME, adapt_bg, adapt_bg_for_palette_mode, adapt_bg_for_theme, adapt_color,
    ...
    #[test]
    fn solarized_light_does_not_mutate_light_text() {
        assert_eq!(
            LIGHT_TEXT_BODY,
            Color::Rgb(
                LIGHT_TEXT_BODY_RGB.0,
