...
//! Priority: WHALE.md > AGENTS.md > .claude/instructions.md > CLAUDE.md > .codesmith/instructions.md > .codesmith/instructions.md
...
/// provide compatibility; `.codesmith/` is the new config directory.
