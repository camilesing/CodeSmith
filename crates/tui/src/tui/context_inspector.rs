...
use crate::models::{LEGACY_MODEL_CONTEXT_WINDOW_TOKENS, SystemPrompt, context_window_for_model};
...
mod tests {
    ...
    fn inspector_text_prompt_without_markers_shows_single_blob() {
        let mut app = test_app();
        app.system_prompt = Some(SystemPrompt::Text("You are CodeSmith.".to_string()));
