...
/// Animation frame characters for the terminal title spinner.
...
///
/// Cycles the terminal title between ◐→◓→◑→◒ every 800ms while
/// processing, so alt-tabbed users can see activity.
///
