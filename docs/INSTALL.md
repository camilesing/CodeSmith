...
`https://github.com/Hmbown/CodeSmith/releases` and the npm package named
...
[Releases page](https://github.com/Hmbown/CodeSmith/releases) and drop them
...
4. Download both `codesmith` and `codesmith-tui` manually from the
   [Releases page](https://github.com/Hmbown/CodeSmith/releases), place them
