...
CodeSmith is built for open-source and open-weight coding models. DeepSeek V4
...
CodeSmith inspect itself and return a small, reviewable improvement.
...
Paste this into CodeSmith from the repository root:
...
リポジトリのルートで、このプロンプトを CodeSmith に貼り付けます。
