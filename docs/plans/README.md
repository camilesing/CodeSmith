...
| [context-engineering.md](context-engineering.md) | 上下文工程（语义检索、prompt zones Phase 2、容量自适应、MCP 客户端补全） | 规划 |
...
2. 真实 tokenizer + 按模型自适应压缩阈值 —— 上下文工程的地基（agent-capability Stage 4 ✅ → context-engineering §3 待执行）
