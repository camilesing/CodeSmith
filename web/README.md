...
Community site for [CodeSmith](https://github.com/camilesing/CodeSmith) — lives at **codesmith.net**.
...
| `GITHUB_REPO`       | Defaults to `camilesing/CodeSmith`                    | optional             |
...
3. **Point the domain:** in the Cloudflare dashboard, add a Worker route for `codesmith.net/*` → the deployed Worker.
