...
const stepsEn = [
  {
    ...
    cta: { label: "Open issues", href: "https://github.com/Hmbown/CodeSmith/issues" },
  },
  {
    n: "②",
    ...
    cta: { label: "Repo on GitHub", href: "https://github.com/Hmbown/CodeSmith" },
  },
  {
    n: "③",
    ...
    cta: { label: "Contributing guide", href: "https://github.com/Hmbown/CodeSmith/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "④",
    title: "Open the PR",
    ...
    cta: { label: "PR template", href: "https://github.com/Hmbown/CodeSmith/blob/main/.github/PULL_REQUEST_TEMPLATE.md" },
  },
];
...
const stepsZh = [
  {
    ...
    cta: { label: "查看议题", href: "https://github.com/Hmbown/CodeSmith/issues" },
  },
  {
    n: "②",
    title: "复刻并创建分支",
    ...
    cta: { label: "GitHub 仓库", href: "https://github.com/Hmbown/CodeSmith" },
  },
  {
    n: "③",
    title: "通过本地检查",
    ...
    cta: { label: "贡献指南", href: "https://github.com/Hmbown/CodeSmith/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "④",
    title: "提交 PR",
    ...
    cta: { label: "PR 模板", href: "https://github.com/Hmbown/CodeSmith/blob/main/.github/PULL_REQUEST_TEMPLATE.md" },
  },
];
        ...
        <>
          ...
          <section id="recursive-harness" className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10 min-w-0">
            <div className="lg:col-span-4 min-w-0">
              ...
              <Link href="https://github.com/Hmbown/CodeSmith/blob/main/docs/RECURSIVE_SELF_IMPROVEMENT.md" className="inline-block mt-5 font-mono text-[0.72rem] uppercase tracking-wider text-indigo hover:underline">
                完整多语言提示词 →
              </Link>
            </div>
          ...
          <section className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              ...
              <p className="text-ink-soft mt-4 leading-[1.9] tracking-wide">
                简而言之：做实事，别折腾元数据。完整的
                <Link href="https://github.com/Hmbown/CodeSmith/blob/main/CODE_OF_CONDUCT.md" className="body-link mx-1">行为准则</Link>
                是详细版。
              </p>
            </div>
          ...
          <section className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              ...
              <p className="text-ink-soft mt-4 leading-relaxed">
                ...
                <Link href="https://github.com/Hmbown/CodeSmith/blob/main/CODE_OF_CONDUCT.md" className="body-link mx-1">Code of Conduct</Link>
                is the long version.
              </p>
            </div>
            <div className="lg:col-span-7">
