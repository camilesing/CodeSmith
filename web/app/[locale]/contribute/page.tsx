...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return {
    title: isZh ? "参与贡献 · CodeSmith" : "Contribute · CodeSmith",
    description: isZh
      ? "如何提交议题、发送合并请求、加入 CodeSmith 社区。"
      : "How to file issues, send pull requests, and join the CodeSmith community.",
  };
}
...
const stepsEn = [
  {
    ...
    cta: { label: "Open issues", href: "https://github.com/camilesing/CodeSmith/issues" },
  },
  {
    n: "②",
    ...
    cta: { label: "Repo on GitHub", href: "https://github.com/camilesing/CodeSmith" },
  },
  {
    n: "③",
    ...
    cta: { label: "Contributing guide", href: "https://github.com/camilesing/CodeSmith/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "④",
    title: "Open the PR",
    ...
    cta: { label: "PR template", href: "https://github.com/camilesing/CodeSmith/blob/main/.github/PULL_REQUEST_TEMPLATE.md" },
  },
];
...
const stepsZh = [
  {
    ...
    cta: { label: "查看议题", href: "https://github.com/camilesing/CodeSmith/issues" },
  },
  {
    n: "②",
    title: "复刻并创建分支",
    ...
    cta: { label: "GitHub 仓库", href: "https://github.com/camilesing/CodeSmith" },
  },
  {
    n: "③",
    title: "通过本地检查",
    ...
    cta: { label: "贡献指南", href: "https://github.com/camilesing/CodeSmith/blob/main/CONTRIBUTING.md" },
  },
  {
    n: "④",
    title: "提交 PR",
    ...
    cta: { label: "PR 模板", href: "https://github.com/camilesing/CodeSmith/blob/main/.github/PULL_REQUEST_TEMPLATE.md" },
  },
];

const recursivePromptEn = `You are running inside CodeSmith on DeepSeek V4 Pro.

Improve CodeSmith itself by finding exactly one small, reviewable friction point in the harness, docs, tests, or contributor workflow.
...
const recursivePromptZh = `你正在 DeepSeek V4 Pro 驱动的 CodeSmith 中运行。

请改进 CodeSmith 本身：只找一个很小、可审查的摩擦点，范围可以是智能体框架、文档、测试或贡献流程。
        ...
        <>
          ...
          <section id="recursive-harness" className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10 min-w-0">
            <div className="lg:col-span-4 min-w-0">
              ...
              <h2 className="font-display text-3xl">让 CodeSmith 改进 CodeSmith</h2>
              <p className="mt-4 text-ink-soft leading-[1.9] tracking-wide">
                100:1 提示词把 DeepSeek V4 Pro 的缓存注意力、工具调用与子智能体，凝结为一个可审查的小补丁——而不是一堆点子。
              </p>
              <Link href="https://github.com/camilesing/CodeSmith/blob/main/docs/RECURSIVE_SELF_IMPROVEMENT.md" className="inline-block mt-5 font-mono text-[0.72rem] uppercase tracking-wider text-indigo hover:underline">
                完整多语言提示词 →
              </Link>
            </div>
          ...
          <section className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              ...
              <p className="text-ink-soft mt-4 leading-[1.9] tracking-wide">
                简而言之：做实事，别折腾元数据。完整的
                <Link href="https://github.com/camilesing/CodeSmith/blob/main/CODE_OF_CONDUCT.md" className="body-link mx-1">行为准则</Link>
                是详细版。
              </p>
            </div>
...
{`# 在 GitHub 上 fork，然后：
git clone git@github.com:YOU/CodeSmith
cd CodeSmith
...
# 一致性验证
cargo test -p codesmith-tui-core --test snapshot --locked
cargo test -p codesmith-protocol --test parity_protocol --locked
cargo test -p codesmith-state --test parity_state --locked
        ...
        <>
          ...
          <section id="recursive-harness" className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10 min-w-0">
            <div className="lg:col-span-4 min-w-0">
              ...
              <h2 className="font-display text-3xl">Let CodeSmith improve CodeSmith</h2>
          ...
          <section className="mx-auto max-w-[1400px] px-6 py-16 grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-5">
              ...
              <p className="text-ink-soft mt-4 leading-relaxed">
                ...
                <Link href="https://github.com/camilesing/CodeSmith/blob/main/CODE_OF_CONDUCT.md" className="body-link mx-1">Code of Conduct</Link>
                is the long version.
              </p>
            </div>
            <div className="lg:col-span-7">
