...
# Homebrew (macOS)
brew tap camilesing/codesmith && brew install codesmith

# Direct download
# https://github.com/camilesing/CodeSmith/releases`}
        </pre>
        <p>
  ...
  },
  {
    ...
    a: (
      <>
        CodeSmith is an independent fork of the open-source project previously known as DeepSeek TUI (later CodeWhale).
        The canonical command is <code className="inline">codesmith</code>, and config lives at <code className="inline">~/.codesmith/</code>.
        DeepSeek remains a first-class provider among many. See <code className="inline">docs/HISTORY.md</code> in the repository for the full project lineage.
      </>
    ),
    sources: ["docs/HISTORY.md", "README.md"],
  },
  {
...
# https://github.com/camilesing/CodeSmith/releases`}
  ...
  },
  {
    ...
    a: (
      <>
        CodeSmith 是曾名为 DeepSeek TUI（后改名 CodeWhale）的开源项目的独立分支。
        主命令是 <code className="inline">codesmith</code>，配置存放在 <code className="inline">~/.codesmith/</code>。
        DeepSeek 仍然是一等 provider 之一。完整项目谱系见仓库中的 <code className="inline">docs/HISTORY.md</code>。
      </>
    ),
    sources: ["docs/HISTORY.md", "README.md"],
  },
