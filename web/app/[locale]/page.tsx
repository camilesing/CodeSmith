...
const FALLBACK_DISPATCH_EN: CuratedDispatch = {
  ...
  highlights: [
    ...
    { title: "Open issues", href: "https://github.com/camilesing/CodeSmith/issues", tag: "opened", blurb: "Start with anything labelled good first issue." },
...
const FALLBACK_DISPATCH_ZH: CuratedDispatch = {
  ...
  highlights: [
    ...
    { title: "开放议题", href: "https://github.com/camilesing/CodeSmith/issues", tag: "opened", blurb: "从 good first issue 标签开始。" },
    ...
    <>
        ...
        <div className="mx-auto max-w-[1400px] px-4 sm:px-6 pt-10 sm:pt-14 pb-12 grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7">
            ...
            <p className="mt-6 text-lg text-ink-soft leading-relaxed max-w-2xl">
              <span className="font-cjk text-indigo font-semibold">CodeSmith</span>
              {isZh
            ...
            <div className="mt-6 flex items-center gap-4 text-xs font-mono text-ink-mute flex-wrap">
              <span>{isZh ? "独立维护者 camilesing" : "Maintained by camilesing"}</span>
              ...
              <pre className="code-block mt-2">
                {isZh ? (
                  <>
                    ...
                    <span className="prompt">$</span> npm install -g codesmith{"\n"}
                    <span className="prompt">$</span> codesmith{"\n"}
                    <br />
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-16">
        ...
        <p className={`mb-8 text-ink-soft max-w-2xl ${isZh ? "leading-[1.9] tracking-wide" : "text-sm leading-relaxed"}`}>
          {isZh
            ? "一个模型回答问题，一个智能体完成任务。区别在于框架——围绕模型构建的规则、工具、证据和反馈循环的运行环境。CodeSmith 围绕三条原则运作。"
            : "A model answers a question. An agent finishes a task. The difference is the harness — the operating environment that surrounds the model with rules, tools, evidence, and feedback loops. CodeSmith operates on three principles."}
        </p>
          ...
          <div className="grid lg:grid-cols-12 gap-10 items-start">
            <div className="lg:col-span-5">
              ...
              <p className={`mt-5 text-ink-soft ${isZh ? "leading-[1.9] tracking-wide" : "leading-relaxed"}`}>
                {isZh
                  ? "1948 年，Ralph Bown 用 100:1 的晶体管模型，把微小的结构讲清楚。CodeSmith 借用同样的形状：一个清晰提示词，把 DeepSeek V4 Pro 的缓存注意力、工具调用与子智能体凝结为一个可审查的小补丁。"
                  : "In 1948, Ralph Bown used a 100-to-1 model of the transistor to make a tiny structure legible. CodeSmith uses the same shape: one clear prompt turns DeepSeek V4 Pro's cached attention, tool use, and sub-agents into one small, reviewable patch."}
              </p>
            ...
            <div className="lg:col-span-7 hairline-t hairline-b hairline-l hairline-r bg-paper">
              <div className="bg-ink text-paper px-4 py-3 flex items-center justify-between gap-4">
                <div className="font-mono text-sm uppercase tracking-widest">CodeSmith / 100:1</div>
              ...
              <div className="grid sm:grid-cols-2 gap-0 col-rule">
                {(isZh
                  ? [
                      { n: "01", t: "输入", d: "贡献者在 fork 中运行 CodeSmith，并给出递归改进提示词。" },
                  ...
                  : [
                      { n: "01", t: "Input", d: "A contributor runs CodeSmith in a fork with the recursive harness prompt." },
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-16">
        ...
        <div className="hairline-t hairline-b hairline-l hairline-r bg-paper p-4 sm:p-8">
          <MermaidDiagram
            label={isZh ? "CodeSmith 运作方式示意图" : "CodeSmith architecture diagram"}
            chart={
              isZh
                ? `flowchart TD
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-14">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <Link href="https://github.com/camilesing/CodeSmith/blob/main/CHANGELOG.md#0848---2026-05-31" className="inline-block mt-4 font-mono text-xs uppercase tracking-wider text-indigo hover:underline">
