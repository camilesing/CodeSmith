...
const FALLBACK_DISPATCH_EN: CuratedDispatch = {
  ...
  highlights: [
    ...
    { title: "Open issues", href: "https://github.com/Hmbown/CodeSmith/issues", tag: "opened", blurb: "Start with anything labelled good first issue." },
...
const FALLBACK_DISPATCH_ZH: CuratedDispatch = {
  ...
  highlights: [
    ...
    { title: "开放议题", href: "https://github.com/Hmbown/CodeSmith/issues", tag: "opened", blurb: "从 good first issue 标签开始。" },
      ...
      <section className="mx-auto max-w-[1400px] px-6 py-14">
        ...
        <div className="grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-5">
            ...
            <Link href="https://github.com/Hmbown/CodeSmith/blob/main/CHANGELOG.md#0848---2026-05-31" className="inline-block mt-4 font-mono text-xs uppercase tracking-wider text-indigo hover:underline">
