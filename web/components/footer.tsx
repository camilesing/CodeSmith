...
const EN_COLS = [
  {
    ...
    items: [
      ...
      { label: "FAQ", href: "/faq" },
      { label: "Releases", href: "https://github.com/Hmbown/CodeSmith/releases" },
    ],
  },
  {
    title: "Community",
    cn: "社区",
    items: [
      { label: "Issues", href: "https://github.com/Hmbown/CodeSmith/issues" },
      { label: "Pull Requests", href: "https://github.com/Hmbown/CodeSmith/pulls" },
      { label: "Discussions", href: "https://github.com/Hmbown/CodeSmith/discussions" },
      { label: "Contribute", href: "/contribute" },
      { label: "Sponsor CodeSmith", href: "https://github.com/sponsors/Hmbown" },
    ],
  },
  {
    title: "Resources",
    ...
    items: [
      ...
      { label: "Code of Conduct", href: "https://github.com/Hmbown/CodeSmith/blob/main/CODE_OF_CONDUCT.md" },
      { label: "Security", href: "https://github.com/Hmbown/CodeSmith/blob/main/SECURITY.md" },
      { label: "License (MIT)", href: "https://github.com/Hmbown/CodeSmith/blob/main/LICENSE" },
    ],
  },
];
...
const ZH_COLS = [
  {
    ...
    items: [
      ...
      { label: "版本发布", href: "https://github.com/Hmbown/CodeSmith/releases" },
    ],
  },
  {
    title: "社区",
    items: [
      { label: "议题", href: "https://github.com/Hmbown/CodeSmith/issues" },
      { label: "合并请求", href: "https://github.com/Hmbown/CodeSmith/pulls" },
      { label: "讨论区", href: "https://github.com/Hmbown/CodeSmith/discussions" },
      { label: "参与贡献", href: "/zh/contribute" },
      { label: "支持 CodeSmith", href: "https://github.com/sponsors/Hmbown" },
    ],
  },
  {
    title: "资源",
    items: [
      ...
      { label: "行为准则", href: "https://github.com/Hmbown/CodeSmith/blob/main/CODE_OF_CONDUCT.md" },
      { label: "安全策略", href: "https://github.com/Hmbown/CodeSmith/blob/main/SECURITY.md" },
      { label: "MIT 许可证", href: "https://github.com/Hmbown/CodeSmith/blob/main/LICENSE" },
    ],
  },
];
      ...
      <div className="mx-auto max-w-[1400px] px-6 py-12 grid grid-cols-2 md:grid-cols-5 gap-10">
        <div className="col-span-2 md:col-span-2 space-y-4">
          <div className="flex items-center gap-3">
            <Seal char="深" size="md" />
            <div>
              <div className="font-display text-xl font-semibold">CodeSmith</div>
          ...
          {isZh && (
            <div className="pt-2 border-t border-paper-line/20">
              ...
              <div className="flex flex-wrap gap-3 text-xs">
                ...
                <a href="https://cnb.cool/codesmith.net/codesmith" className="text-indigo hover:underline" target="_blank" rel="noopener">CNB 镜像</a>
                <a href="https://npmmirror.com/package/codesmith" className="text-indigo hover:underline" target="_blank" rel="noopener">npmmirror</a>
      ...
      <div className="hairline-t">
        <div className="mx-auto max-w-[1400px] px-6 py-4 flex flex-col gap-2 text-[0.78rem] text-ink-soft">
          <div>
            ...
            <a href="mailto:security@codesmith.net" className="font-mono text-ink hover:text-indigo">security@codesmith.net</a>
          </div>
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 font-mono text-[0.7rem] text-ink-mute uppercase tracking-widest">
            <span>© {new Date().getFullYear()} · CodeSmith · Hmbown</span>
