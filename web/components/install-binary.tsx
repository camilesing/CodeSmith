...
const SNIPPETS: Record<Arch, string> = {
  ...
  https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-macos-arm64
curl -fsSL -o codesmith-tui \\
  https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-tui-macos-arm64
...
sudo mv codesmith codesmith-tui /usr/local/bin/`,
  ...
  https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-macos-x64
curl -fsSL -o codesmith-tui \\
  https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-tui-macos-x64
chmod +x codesmith codesmith-tui
xattr -d com.apple.quarantine codesmith codesmith-tui 2>/dev/null || true
sudo mv codesmith codesmith-tui /usr/local/bin/`,
  "linux-x64": `curl -fsSL -o codesmith \\
  https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-linux-x64
curl -fsSL -o codesmith-tui \\
  https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-tui-linux-x64
chmod +x codesmith codesmith-tui
sudo mv codesmith codesmith-tui /usr/local/bin/`,
...
Invoke-WebRequest \`
  -Uri https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-windows-x64.exe \`
  -OutFile "$dest\\codesmith.exe"
Invoke-WebRequest \`
  -Uri https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-tui-windows-x64.exe \`
...
const VERIFY: Record<Arch, string> = {
  "macos-arm64": `curl -fsSL -O https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-artifacts-sha256.txt
shasum -a 256 -c codesmith-artifacts-sha256.txt --ignore-missing`,
  "macos-x64": `curl -fsSL -O https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-artifacts-sha256.txt
shasum -a 256 -c codesmith-artifacts-sha256.txt --ignore-missing`,
  "linux-x64": `curl -fsSL -O https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-artifacts-sha256.txt
sha256sum -c codesmith-artifacts-sha256.txt --ignore-missing`,
  "linux-arm64": `curl -fsSL -O https://github.com/camilesing/CodeSmith/releases/latest/download/codesmith-artifacts-sha256.txt
sha256sum -c codesmith-artifacts-sha256.txt --ignore-missing`,
  "windows-x64": `# PowerShell
