...
export const TRIAGE_PROMPT = `You are a community triage assistant for the CodeSmith open source project (Hmbown/CodeSmith).
...
export const PR_REVIEW_PROMPT = `You are a community PR review assistant for the CodeSmith open source project (Hmbown/CodeSmith).
...
export const STALE_PROMPT = `You are a community maintenance assistant for the CodeSmith open source project (Hmbown/CodeSmith).
...
export const DUPES_PROMPT = `You are a community deduplication assistant for the CodeSmith open source project (Hmbown/CodeSmith).
...
export const DIGEST_PROMPT = `You are the editor of a weekly digest for the CodeSmith open source project (Hmbown/CodeSmith).
