...
- Never recommend a package, URL, command, or service that is not already in the CodeSmith repo's docs or this prompt.
...
export const TRIAGE_PROMPT = `You are a community triage assistant for the CodeSmith open source project (camilesing/CodeSmith).
...
export const PR_REVIEW_PROMPT = `You are a community PR review assistant for the CodeSmith open source project (camilesing/CodeSmith).
...
export const STALE_PROMPT = `You are a community maintenance assistant for the CodeSmith open source project (camilesing/CodeSmith).
...
export const DUPES_PROMPT = `You are a community deduplication assistant for the CodeSmith open source project (camilesing/CodeSmith).
...
export const DIGEST_PROMPT = `You are the editor of a weekly digest for the CodeSmith open source project (camilesing/CodeSmith).
