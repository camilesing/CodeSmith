 ...
 *
 *   "Shipped"    ← last 8 published Releases on Hmbown/CodeSmith
 ...
 */
const REPO = process.env.GITHUB_REPO ?? "Hmbown/CodeSmith";
...
async function gh<T>(url: string, ghToken?: string): Promise<T | null> {
  const headers: Record<string, string> = {
    ...
    "User-Agent": "codesmith-web-roadmap",
...
const FALLBACK_SHIPPED: RoadmapItem[] = [
  {
    ...
    href: "https://github.com/Hmbown/CodeSmith/releases/tag/v0.8.45",
  },
];
